...
export const SCREENING_DISCLAIMER = "본 검사는 진단 도구가 아니라 선별용 자가체크입니다. 정확한 평가는 임상심리사, 정신건강의학과, 특수교육 전문가 등이 실시하는 표준화 지능검사와 적응행동검사, 면담을 통해 이루어져야 합니다. 본 결과만으로 경계선 지능 여부를 확정하지 않습니다.";
...
export const adultResultLevels: ResultLevel[] = [
  {
    ...
    description: "현재 응답만으로는 학습·인지·적응기능 어려움 가능성이 낮아 보입니다. 다만 이 결과가 모든 상황을 설명하지는 않습니다.",
  ...
  },
  {
    ...
    description: "일부 영역에서 어려움이 나타납니다. 피로, 스트레스, 수면, 주의력, 정서 상태에 따라 일시적으로 높게 나타날 수도 있습니다.",
  ...
  },
  {
    ...
    level: "moderate",
    title: "주의 — 전문 평가 권장",
    description: "여러 영역에서 어려움이 관찰됩니다. 본 결과만으로 경계선 지능 여부를 판단하지는 않지만, 현재 기능 수준을 더 자세히 살펴볼 필요가 있습니다.",
    recommendation: "임상심리사, 정신건강의학과, 상담센터 등에서 표준화 지능검사와 적응행동검사, 면담을 포함한 평가를 받아보는 것을 권합니다.",
  ...
  },
  {
    ...
    level: "high",
    title: "높음 — 표준화 검사 권장",
    description: "경계선 지능 또는 주의력, 정서, 학습 문제 등과 관련된 어려움 가능성이 있어 표준화 검사를 권합니다. 이 결과는 선별 신호이며 최종 판단이 아닙니다.",
    recommendation: "가능하면 임상심리사, 정신건강의학과, 특수교육 전문가와 상의해 K-WAIS 등 표준화 지능검사, 적응행동검사, 면담을 포함한 평가를 받아보세요. 필요한 지원을 찾기 위한 과정으로 이해하는 것이 좋습니다.",
...
export const childResultLevels: ResultLevel[] = [
  {
    ...
    level: "low",
    title: "낮음 — 현재 응답상 어려움 가능성 낮음",
    description: "현재 응답만으로는 학습·인지·적응기능 어려움 가능성이 낮아 보입니다. 다만 발달과 학습은 환경과 시기에 따라 달라질 수 있습니다.",
  ...
  },
  {
    ...
    level: "mild",
    title: "주의 — 일부 영역 점검 필요",
    description: "일부 영역에서 어려움이 나타납니다. 수면, 정서, 주의집중, 학습 환경, 과제 난이도에 따라 응답이 높아질 수 있습니다.",
  ...
  },
  {
    ...
    level: "moderate",
    title: "주의 — 전문 평가 권장",
    description: "여러 영역에서 어려움이 관찰됩니다. 본 결과만으로 경계선 지능 여부를 판단하지는 않지만, 학습·인지·적응기능을 더 자세히 살펴볼 필요가 있습니다.",
    recommendation: "소아정신건강의학과, 임상심리사, 발달센터, 특수교육 전문가와 상의해 표준화 지능검사와 적응행동검사, 면담을 포함한 평가를 받아보는 것을 권합니다.",
    color: "oklch(0.65 0.15 30)"
  },
  {
    min: 41, max: 54,
    ...
    title: "높음 — 표준화 검사 권장",
    description: "경계선 지능 또는 주의력, 정서, 학습 문제 등과 관련된 어려움 가능성이 있어 표준화 검사를 권합니다. 이 결과는 선별 신호이며 최종 판단이 아닙니다.",
    recommendation: "가능하면 소아정신건강의학과, 임상심리사, 특수교육 전문가와 상의해 K-WISC 등 표준화 지능검사, Vineland·ABAS·NISE-K·ABS 등 적응행동검사, 면담을 포함한 평가를 받아보세요. 결과는 자녀에게 맞는 지원을 찾기 위한 자료로 활용해 주세요.",
    color: "oklch(0.55 0.2 25)"
  },
];
