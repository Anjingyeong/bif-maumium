...
export const adultResultLevels: ResultLevel[] = [
  {
    ...
    level: "low",
    title: "정상 범위",
    description: "현재 응답 결과, 경계선 지능과 관련된 어려움이 거의 관찰되지 않습니다.",
    recommendation: "특별한 조치가 필요하지 않습니다. 일상생활에서 불편함을 느끼신다면 스트레스 관리에 신경 써주세요.",
  ...
  },
  {
    ...
    level: "mild",
    title: "경미한 수준",
    description: "일부 영역에서 경미한 어려움이 관찰됩니다. 이는 스트레스, 피로, 또는 환경적 요인일 수 있습니다.",
    recommendation: "현재 큰 걱정은 필요하지 않지만, 지속적인 어려움이 있다면 전문 상담을 고려해보세요.",
  ...
  },
  {
    ...
    level: "moderate",
    title: "주의 필요",
    description: "여러 영역에서 어려움이 관찰됩니다. 경계선 지적 기능의 가능성을 고려해볼 수 있습니다.",
    recommendation: "정신건강의학과 또는 심리상담센터에서 전문적인 지능검사(웩슬러 검사)를 받아보시는 것을 권장합니다.",
  ...
  },
  {
    ...
    level: "high",
    title: "전문가 상담 권장",
    description: "다수의 영역에서 뚜렷한 어려움이 관찰됩니다. 전문적인 평가가 필요합니다.",
    recommendation: "가능한 빨리 전문기관을 방문하여 종합적인 인지 평가를 받으시기 바랍니다. 조기 지원이 도움이 됩니다.",
...
export const childResultLevels: ResultLevel[] = [
  {
    ...
    level: "low",
    title: "정상 발달 범위",
    description: "현재 응답 결과, 자녀의 발달이 또래 수준에서 크게 벗어나지 않는 것으로 보입니다.",
    recommendation: "특별한 조치가 필요하지 않습니다. 자녀의 성장을 따뜻하게 지켜봐 주세요.",
  ...
  },
  {
    ...
    level: "mild",
    title: "관찰 필요",
    description: "일부 영역에서 또래보다 느린 발달이 관찰됩니다. 환경적 요인이나 일시적 지연일 수 있습니다.",
    recommendation: "학교 담임선생님과 상담하고, 6개월 후 재평가를 권장합니다. 가정에서 추가 학습 지원을 고려해보세요.",
  ...
  },
  {
    ...
    level: "moderate",
    title: "전문 평가 권장",
    description: "여러 영역에서 또래 대비 발달 지연이 관찰됩니다. 경계선 지적 기능의 가능성을 고려해볼 수 있습니다.",
    recommendation: "소아정신건강의학과 또는 발달센터에서 전문적인 발달 평가 및 지능검사(K-WISC)를 받아보시기 바랍니다.",
  ...
  },
  {
    ...
    level: "high",
    title: "조기 개입 필요",
    description: "다수의 영역에서 뚜렷한 발달 지연이 관찰됩니다. 전문적인 평가와 지원이 시급합니다.",
    recommendation: "가능한 빨리 전문기관을 방문하여 종합 발달 평가를 받으시기 바랍니다. 조기 개입이 아이의 성장에 큰 도움이 됩니다.",
